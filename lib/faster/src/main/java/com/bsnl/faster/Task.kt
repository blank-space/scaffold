...
import com.bsnl.faster.utils.DispatcherExecutor
import java.util.concurrent.CountDownLatch
import java.util.concurrent.ExecutorService

abstract class Task : ITask {
    protected var mTag = javaClass.simpleName
    protected var mContext: Context? = TaskDispatcher.Companion.context

    /**
     * 当前进程是否是主进程
     */
    protected var mIsMainProcess: Boolean = TaskDispatcher.Companion.isMainProcess
