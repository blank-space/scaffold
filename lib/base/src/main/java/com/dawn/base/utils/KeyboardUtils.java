...
public final class KeyboardUtils {
    ...
    public static void showSoftInput() {
        InputMethodManager imm = (InputMethodManager) BaseApp.application.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    public static void showSoftInput(@NonNull final View view, final int flags) {
        InputMethodManager imm =
                (InputMethodManager) BaseApp.application.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
