package com.dawn.base.widget.titlebar
...
class ToolbarTitleView : LinearLayout, ITitleView {
    ...
    override fun onFinishInflate() {
        ...
        mToolbarLeftTv =
            findViewById(R.id.toolbar_left_tv) as TextView
    ...
    override fun setTitleGravityLeft(): ToolbarTitleView {
        val params = mTitleTv!!.layoutParams as RelativeLayout.LayoutParams
    ...
    override fun addMenuItem(
        ...
        val root: View =
            LayoutInflater.from(context).inflate(R.layout.base_top_bar_btn, null)
        val btnTxt =
    ...
    override fun getRightLayout(): View? {
        return mToolbarRightLayout
    }
}