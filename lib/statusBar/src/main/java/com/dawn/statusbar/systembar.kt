...
val Activity.screenWidth: Int @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
get() = screenSize.width

val Activity.screenHeight: Int @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
